...
- 其他
  > When it comes to ... 说到某事时
  > It feels like a roller coaster
  > public transport
  > unheard of
  > You should put one more layers / You might wanna loose that jacket
  ...
  > series
    ...
    > absolutely + adj(stunning、beautiful、fabulous)
    > highly + adj(recommended、effective、profitable、unlikely)
    > perfectly normal
    > reasonably priced
    > utterly + 不好的adj(despicable、stupid、ridiculous)
    > widely accepted
    > deeply offended
    > strongly disagree
    > actively involved
...
- interview
  ...
  > I was let go after a change in management / I was let go due to company downsizing / I was not a great fit as a ... because my strengths were in ... so I'm going to focus on from this point on
...
- 打电话
  ...
  > Hang on a sec / Would you mind hold on a moment please?
  ...
  > I have a missed call from this number. Who am I speaking with?
...
- 涨薪
  ...
  > When I first got started on my position, I was responsible for A,B and C. I successfully completed all these tasks, and now I have picked up C and D, And I believe I'm doing a good job on it, I say this because I have achieved this and this
...
- 下班了
  ...
  > I'm off
  > I'm just leaving work now. I'll see you there in 20 [minutes]
...
- I'm still working on it
  > We're still just fine-tuning/polishing up a few final details
  > We're done with most of it
  > We've got the biggest part of the project taken care of, We're close to the finish line
  > After that it'll be smooth sailing. It's all downhill from there
...
- 无奈
  > I can't even
  > I [just] can't / I can't with her/him
  > There's nothing I can do about this / I have no control over this / My hand are tied
  > It's what it is / What's done is done
  > We'll have to make do with what we got

- 拒绝做某事
  > I wish I could, but I already have plans on that day
  > ...,It's my policy
  > I'd rather not talk about this at work, That's private
...
- 道歉
  > My bad
  > This one is on me, let me make it up [to you / by doing sth]
  > This is my fault, I shouldn't have done this without telling you /I screwed/messed up, I'll do anything to make it better
  > I feel terrible for letting you down
  > I owe you an apology, I shouldn't have spoken to you in that tone/like that in the meeting. It was unprofessional on my part. I apologize
...
- 代替busy
  ...
  > I'm expecting things to cool down in a week when I get this part done

- 代替think
  > As far as the new project goes, the only thing I would/wouldn't point out is the timing
  > From where I stand/from a marking perspective/from my point of view, timing could be an issue.I'm onboard with this proposal
  > I do believe ...
  > To me it feels like we've pretty much covered every ground and I think we're good to go
  > Judging from what I've heard, it doesn't seem like we have a solution to this issue yet, and this is a very import aspect as to whether we could be successful or not. so I would recommend/suggest that we get this taken care of before we move on to the next step
  > This is the first time that this subject was brought to my attention. but based on what I've heard/read, It sounds promising. We've still got a long way to go

- 代替I don't know
  > That's an interesting/good question, I haven't really thought about it.(I haven't given this much thought), let me think about that for a second(let me get back to you on that)
  > That's an good question, I'd like go over it with my team (I'd like some time to think it over) (do more research before I give you an exact answer)
  > It's still a fairly new product/concept. I don't think I know enough to have an opinion about it(enough facts to make an informed decision) yet, It sounds exciting and people've been saying good things about it, so I'm open to learn more about it
...
- 解释一下
  ...
  > I'm still a bit unsure of that you are getting at. Could you be a little more specific?
...
- 纠正某人行为
  ...
  > Your comment/behavior/remark is extremely inappropriate/racist
...
- 针对我的
  > It's personal
  > I feel singled out
  > I feel like they're just trying to make me look bad
  > I won't go down without a fight
  > I will fight back

- 商店开门/关门
  > What are you [store] hours [today]?   营业时间
  > We're open from 10-5 on week days, On the weekend is 1-5
  > When/What time do you close today/tonight?
  > How late are you open? / What time are you open until? I need to return an item I got and I won't get off work until 8pm
  > When/What time are you open?
  > Are you open everyday/on weekend?
...
- 崩溃
  ...
  > I'm on the brink of a nervous/mental breakdown
...
- 走神
  > I was zoning out
  > I went blank for a moment/minute

- 不吃这一套
  > These tricks you play, it gets old
...
- show
  ...
  > This show has a lot of plot holes / The story is not coherent
...
- 钻牛角尖
  ...
  > Don't dwell on the past/ little details
  > Focus on the future/ the big picture
...
- 嫌弃
  ...
  > I saw the look of despise on her face
  > Thank you for putting up with me all these years  包容/不嫌弃
  > sb put up sb to sth 指使某人做xx

- 下贱
  > Mary is so pathetic, He is such a people pleaser(讨好别人), she will do whatever it takes to get the other person to like her
